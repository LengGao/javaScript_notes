...
let match2 = str1.match('123')
let match3 = '123asd123'.matchAll(/123/g)
for (const iterator of match3) {
  console.log('iterator:', iterator);
}
// for (const key in match2) {
//   if (match2.hasOwnProperty(key)) {
//     const element = match2[key];
//     console.log('element:', element, key);
//   }
// }
console.log('match:', match, match2['input'], match3) // match: [ '123' ]
// [ '123', index: 0, input: '123abcEFG&^()', groups: undefined ]
...
// es6
let startsWith_string = 'sss'
console.log('startsWith:', startsWith_string.startsWith('s', -1));
let endsWith_string = 'eee'
console.log('endsWith:', endsWith_string.endsWith('e', 1));
